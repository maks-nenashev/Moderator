...
V3_REVIEW = THRESHOLDS_V3.get("review_threshold", 0.3477)
V4_REVIEW = THRESHOLDS_V4.get("review_threshold", 0.45)
V4_1_REVIEW = THRESHOLDS_V4_1.get("review_threshold", 0.65) # <-- NEW (Сленг)
...
def apply_policy(
    ...
    - v3/v4/v4.1: REVIEW signal (Sexual Intent)
    """
    reasons = []
